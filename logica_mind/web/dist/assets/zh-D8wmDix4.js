...
• 危险区域——永久删除特定层级的记忆，或移除过期条目（超过 60 天）。`,analytics:"分析",analytics_sub:"使用情况、活动与可靠性。",memories_over_time:"已添加记忆",last_30_days:"最近 30 天",all_time:"全部时间",open_in_graph:"在图谱中打开",open_in_memories:"在记忆中打开",last_n_days:"最近 {n} 天",by_layer:"按层级",by_source:"按来源",by_agent:"按智能体",avg_latency:"平均延迟",requests_word:"请求",error_rate:"错误率",memory_lake:"记忆湖",lake_subject:"主体",lake_entities:"实体",lake_facts:"事实",lake_activity:"活动",lake_updated:"已更新",lake_type:"类型",gov_provenance:"溯源",gov_erase:"可 GDPR 擦除",gov_versioned:"已版本化",gov_sourced:"已标注来源",gov_note:"在可用时标注来源并追踪溯源；更新已版本化；每一行均可应请求擦除。",context:"上下文",context_block:"上下文块",context_block_sub:"智能组装——按令牌预算适配的排序候选项。",context_query_ph:"智能体需要知道什么？",token_budget:"令牌预算",tokens_word:"令牌",utilized:"已使用",candidates_selected:"已选",ranked_candidates:"排序候选项",assembled_block:"组装块",copy:"复制",copied:"已复制",context_empty:"输入查询以组装上下文块。",context_foot:"仅注入排名最高且符合预算的记忆——绝不浪费。",observations:"观察",observations_sub:"跨众多事实的模式——而非存在于任何单条事实之中。",observations_empty:"图谱还不足以检测模式。",recurring_pairs:"反复一同出现",central_entities:"中心实体",relations_word:"关系",shared_word:"共享",observations_foot:"从时间图谱中按结构检测——连通性与共现，随记忆增长重新计算。",intg_pick_hint:"点按以用于整个心智",intg_click_use:"用此模型服务整个心智",intg_click_off:"关闭（无 LLM 写入）",dream_cadence:"梦境计划",dream_interval:"运行间隔（小时）",dream_batch:"每个周期蒸馏的轮次",dream_auto_on:"自动",dream_auto_off:"已暂停",dream_cadence_hint:"梦境运行的频率，以及每次将多少原始轮次蒸馏成事实。需要连接 LLM（设置 → 集成）。",saved:"已保存"};export{e as default};
