...
The life/work dimension profile, and the derived backlinks built on top of it and the graph. See [Fact categorization](./categorization.md) and [Connections](./connections.md).
