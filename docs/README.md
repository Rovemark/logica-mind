# Logica Mind — Documentation

Long-term memory for AI agents — episodic, semantic, a temporal knowledge graph
and a dialectic user model in one library. Offline by default, no API key
required to start.
...
### Getting started
- [Installation](installation.md) — install the package and optional providers
- [Quickstart](quickstart.md) — your first memories, recall, and the dashboard
- [Core concepts](concepts.md) — the four memory layers and how recall works
