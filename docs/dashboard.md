...
The interface is translated into three languages — **English** (`en`, the default), **Português** (`pt`), and **Español** (`es`). Missing keys fall back to English. The active language is remembered in the browser. Switch both theme and language from the **Settings** panel.
